...
namespace XNATWL.Test
{
    public class SimpleTest
    {
        ...
        public SimpleTest(GraphicsDevice graphicsDevice)
        {
            ...
            this.themeRootFso = new IO.FileSystemObject(IO.FileSystemObject.FileSystemObjectType.Directory, System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Theme"));
