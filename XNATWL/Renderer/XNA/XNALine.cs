...
freely, subject to the following restrictions:
    ...
    */
    ...
    public static class Primitives2D
    {
        ...
        private static void DrawPoints(SpriteBatch spriteBatch, Vector2 position, List<Vector2> points, Microsoft.Xna.Framework.Color color, float thickness)
        {
            if (points.Count < 2)
                return;
        ...
        public static void FillRectangle(this SpriteBatch spriteBatch, Rectangle rect, Microsoft.Xna.Framework.Color color)
        {
            if (pixel == null)
            {
        ...
        public static void FillRectangle(this SpriteBatch spriteBatch, Rectangle rect, Microsoft.Xna.Framework.Color color, float angle)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
        ...
        /// <param name="color">The color to draw the rectangle in</param>
        public static void FillRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Microsoft.Xna.Framework.Color color)
        {
        ...
        /// <param name="angle">The angle in radians to draw the rectangle at</param>
        /// <param name="color">The color to draw the rectangle in</param>
        public static void FillRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Microsoft.Xna.Framework.Color color, float angle)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
        ...
        /// <param name="color">The color to draw the rectangle in</param>
        public static void FillRectangle(this SpriteBatch spriteBatch, float x, float y, float w, float h, Microsoft.Xna.Framework.Color color)
        {
        ...
        public static void FillRectangle(this SpriteBatch spriteBatch, float x, float y, float w, float h, Microsoft.Xna.Framework.Color color, float angle)
        {
        ...
        /// <param name="rect">The rectangle to draw</param>
        /// <param name="color">The color to draw the rectangle in</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rect, Microsoft.Xna.Framework.Color color)
        {
        ...
        /// <param name="color">The color to draw the rectangle in</param>
        /// <param name="thickness">The thickness of the lines</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rect, Microsoft.Xna.Framework.Color color, float thickness)
        {
        ...
        /// <param name="size">The size of the rectangle</param>
        /// <param name="color">The color to draw the rectangle in</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Microsoft.Xna.Framework.Color color)
        {
        ...
        public static void DrawRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Microsoft.Xna.Framework.Color color, float thickness)
        {
        ...
        /// <param name="color">The color to use</param>
        public static void DrawLine(this SpriteBatch spriteBatch, float x1, float y1, float x2, float y2, Microsoft.Xna.Framework.Color color)
        {
        ...
        /// <param name="color">The color to use</param>
        /// <param name="thickness">The thickness of the line</param>
        public static void DrawLine(this SpriteBatch spriteBatch, float x1, float y1, float x2, float y2, Microsoft.Xna.Framework.Color color, float thickness)
        {
        ...
        /// <param name="color">The color to use</param>
        public static void DrawLine(this SpriteBatch spriteBatch, Vector2 point1, Vector2 point2, Microsoft.Xna.Framework.Color color)
        {
        ...
        /// <param name="color">The color to use</param>
        /// <param name="thickness">The thickness of the line</param>
        public static void DrawLine(this SpriteBatch spriteBatch, Vector2 point1, Vector2 point2, Microsoft.Xna.Framework.Color color, float thickness)
        {
        ...
        /// <param name="color">The color to use</param>
        public static void DrawLine(this SpriteBatch spriteBatch, Vector2 point, float length, float angle, Microsoft.Xna.Framework.Color color)
        {
        ...
        /// <param name="color">The color to use</param>
        /// <param name="thickness">The thickness of the line</param>
        public static void DrawLine(this SpriteBatch spriteBatch, Vector2 point, float length, float angle, Microsoft.Xna.Framework.Color color, float thickness)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
        ...
        public static void PutPixel(this SpriteBatch spriteBatch, float x, float y, Microsoft.Xna.Framework.Color color)
        {
            PutPixel(spriteBatch, new Vector2(x, y), color);
        }


        public static void PutPixel(this SpriteBatch spriteBatch, Vector2 position, Microsoft.Xna.Framework.Color color)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
        ...
        public static void DrawCircle(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides, Microsoft.Xna.Framework.Color color)
        {
        ...
        public static void DrawCircle(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides, Microsoft.Xna.Framework.Color color, float thickness)
        {
        ...
        /// <param name="sides">The number of sides to generate</param>
        /// <param name="color">The color of the circle</param>
        public static void DrawCircle(this SpriteBatch spriteBatch, float x, float y, float radius, int sides, Microsoft.Xna.Framework.Color color)
        {
        ...
        /// <param name="color">The color of the circle</param>
        /// <param name="thickness">The thickness of the lines used</param>
        public static void DrawCircle(this SpriteBatch spriteBatch, float x, float y, float radius, int sides, Microsoft.Xna.Framework.Color color, float thickness)
        {
        ...
        public static void DrawArc(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides, float startingAngle, float radians, Microsoft.Xna.Framework.Color color)
        {
        ...
        public static void DrawArc(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides, float startingAngle, float radians, Microsoft.Xna.Framework.Color color, float thickness)
        {
